<div >
    <nav class="row ">
        ...
        <div class="col-12 navbar navbar-expand-lg " style="background:#000D6B">
            <div class="container py-1 px-5" >
                ...
                <h5 class="fw-bold text-white">E-SHOP</h5>
                ...
                <div class="">
                        @if(session()->has('name'))
                        @if(session('role')=== 'admin')
                        <span class="fw-bold text-white"><i class="fas fa-user-circle px-1"></i>Admin : {{
                            session('name') }}</span>
                        @elseif(session('role')== 'seller')
                        <span class="fw-bold" style="color: white;"><i class="fas fa-user-circle px-1"></i>Seller : {{ session('name') }}</span>

                        @elseif(session('role')== 'customer')
                        <span class="fw-bold text-white"><i class="fas fa-user-circle px-1"></i>Customer : {{
                            session('name') }}</span>

                        @elseif(session('role')== 'service')
                        <span class="fw-bold text-white"><i class="fas fa-user-circle px-1"></i>Service : {{
                            session('name') }}</span>
                        @endif
                        @endif
                    </div>
