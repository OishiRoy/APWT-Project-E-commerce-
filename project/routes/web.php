...
//     return view('pages.template.products');
// })->name('products');

// Route::get('/product_details', function () {
//     return view('pages.template.product_details');
// });

// Route::get('/account', function () {
//     return view('pages.template.account');
// });

// Route::get('/cart', function () {
//     return view('.pages.template.cart');
// });
// end template
...
// Service Providers controller for admin
